...
if __name__ == "__main__":
    ...
    wandb.init(project='IncreNat', name=args.exp_name, tags=args.tags.split('-') if args.tags is not None else None, resume=True if args.resume is not None else None)
    ...
    for stage_idx in range(1, args.max_stage + 1):
        ...
        args.target_transforms.append(args.target_transform)
